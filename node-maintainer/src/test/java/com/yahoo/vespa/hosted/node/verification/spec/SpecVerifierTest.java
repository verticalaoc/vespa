...
//        HardwareInfo actualHardware = new HardwareInfo(minDiskAvailableGb, minMainMemoryAvailableGb, minCpuCores, interfaceSpeedMbs, ipv4Addresses, ipv6Addresses, diskType);
...
//        nodeInfoUrls.add(new URL(URL_RESOURCE_PATH + "/nodeRepo.json"));
//        NodeRepoJsonModel actualNodeRepoJsonModel = SpecVerifier.getHardwareInfoFromNodeRepo(nodeInfoUrls);
